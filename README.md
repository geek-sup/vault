...
Atention: ⚠️ You will be able turn on the switch button to export all your passwords in a plain text to make it easier to import it again, but you have to validate your creadential before. If your password is incorrectly or you leve it unchecked then it will export all the passwords encrypted.
...
<img src="/images/settings.png" alt="Key Screen" width="300" height="200"> <img src="/images/log.png" alt="Key Screen" width="300" height="200">
